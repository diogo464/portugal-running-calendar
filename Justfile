...
ci: build
    ssh diogo464@prod podman run -itd --restart=always -p 42157:80 --pull=always --name portugal-running-calendar --replace cr.d464.sh/portugal-running-calendar:latest
